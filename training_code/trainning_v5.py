		...
		while True:
			...
			if reply==True:		
				print("saving data for steady state, Trial#%i" %j)	
						#pdb.set_trace()
				new_feat=Feature(frame, gray, pix_cent_gray,pix_cent_bgr, mean_intensity,mean_intensity_bgr, pixels_bgr,pixels_gray,"SS")
				Dtr.append(new_feat)
				break
		...
		for j in range(0,int(num_trials)):
			...
			while True:
				...
				if reply==True:		
					...
					#pdb.set_trace()
					new_feat=Feature(frame, gray, pix_cent_gray,pix_cent_bgr, mean_intensity, mean_intensity_bgr, pixels_bgr,pixels_gray,i)
					Dtr.append(new_feat)
					break
	#pdb.set_trace()
